...
const Button = ({ props, className, buttonColor = "blue" , color="", padding="12px", width="", text="", border="" }) => {
  return (
    <div>
      <a href="https://app.1inch.io/swap?src=1:ETH&dst=1:USDC">
        <button
        style={{backgroundColor:buttonColor, color:color, padding:padding, width:width, fontSize:text, border:border}}
